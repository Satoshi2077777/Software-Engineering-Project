		...
		jb_submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (rb_teacher.isSelected()) {
					...
					if (teacher == null) {
						JOptionPane.showMessageDialog(RegisterView.this, "<html><font size=5>用户名不存在</font></html>");
						init();
						return;
					} else {
						if ((!(psw).equals(again_psw)) || "".equals(psw)) {
							...
							if (teacher1 != null) {
								JOptionPane.showMessageDialog(RegisterView.this,
										"<html><font size=5>用户已注册</font></html>");
								init();
								return;
							}
							...
							if (flag != 0) {
								JOptionPane.showMessageDialog(RegisterView.this,
										"<html><font size=5>注册成功</font></html>");
								RegisterView.this.dispose();
								new LoginView();
							} else {
								init();
								JOptionPane.showMessageDialog(RegisterView.this,
										"<html><font size=5>注册失败</font></html>");
							}
					...
					JOptionPane.showMessageDialog(RegisterView.this, "角色未选中");
				}
			}
		});
